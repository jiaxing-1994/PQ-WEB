            ...
            <table border="0" cellpadding="10" cellspacing="0" v-show="Object.keys(positionList).length>0">
                ...
                <tbody id="list-body">
                    ...
                    <tr class="position-item-all">
                        ...
                        </td><td :class="vTotalFloatProfit>0?vTotalFloatProfit==0?'':'colorUp':'colorDown'">
                            <span v-if="rmbOrUsd==1">￥{{(vTotalFloatProfit/rateList.CNY.exchangeRate).toFixed(2)}}</span>
                            <span v-if="rmbOrUsd==2">${{vTotalFloatProfit.toFixed(2)}}</span>
                            <span v-if="rmbOrUsd==3">￥{{(vTotalFloatProfit/rateList.CNY.exchangeRate).toFixed(2)}}(${{vTotalFloatProfit.toFixed(2)}})</span>
                        </td>
                    </tr>
                </tbody>
            </table>
...
export default {
    ...
    data(){
        return{
            ...
            isShowLayer:false,
            awardBgImg:require('../../../../assets/imgs/my/cash.png'), //现金红包背景图片
            awardBgImg2:require('../../../../assets/imgs/my/cost.png'), //手续费红包背景图片
        }
    },
    computed:{
        ...mapState([
    ...
    watch:{
        ...
        couponName:function(){
            if(this.couponName == '现金红包'){
                this.awardBgImg = require('../../../../assets/imgs/my/cash.png'); //现金红包背景图片
            }else{
                this.awardBgImg = require('../../../../assets/imgs/my/cost.png'); //现金红包背景图片
            }
        }
    },
    mounted(){
