    ...
    methods:{
        ...
        stopConfirm(){
			...
			var params = {
                StopLossNo:this.selectContractItem.StopLossNo, //止损编号
                ModifyFlag:0,
                Num:this.$refs.stopLayer.handNum,
                StopLossType:this.$refs.stopLayer.tabType==2?1:this.$refs.stopLayer.priceType.value,
                OrderType:1,
                StopLossPrice:this.$refs.stopLayer.priceType.value==2?(this.selectContractItem.HoldDirection==0?this.selectLastData[3]-this.$refs.stopLayer.floatPrice:this.selectLastData[3]+this.$refs.stopLayer.floatPrice):Number(this.$refs.stopLayer.price),
