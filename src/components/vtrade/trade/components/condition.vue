<template>
    <div class="condition">
        ...
        <div class="confirm-btn">
            <span class="confirm-btn-item buy" @click="confirmBtn(0)" v-show="isLoginApp&&isVTradeLogin">
                {{tradeType==0?'模拟买入':'买入'}}/{{priceType==1?'市价':'对手价'}}
            </span>
            <span class="confirm-btn-item sell" @click="confirmBtn(1)" v-show="isLoginApp&&isVTradeLogin">
