<template>
    <div class="buy">
        ...
        <div :class="['confirm-btn',!isLoginApp?'login-btn':'']">
            <span class="confirm-btn-item" style="margin-left:0" v-show="isLoginApp&&isTradeLogin" @click="confirmBtn(0)">
                {{tradeType==0?'模拟买入':'买入'}}/{{currentPrice}}
            </span>
            <span class="confirm-btn-item confirm-btn-item-sell" style="margin-right:0" v-show="isLoginApp&&isTradeLogin" @click="confirmBtn(1)">
