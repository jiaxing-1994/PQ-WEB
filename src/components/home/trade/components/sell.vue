<template>
    <div class="sell">
        ...
        <div :class="['confirm-btn',!isLoginApp?'login-btn':'']">
            <span class="confirm-btn-item" v-show="isLoginApp&&isTradeLogin" @click="confirmBtn">
        ...
        <div class="layer-content confirm-layer" id="sell-layer-content">
    ...
    methods:{
        ...
        confirmBtn(){
            ...
            this.$layer({
                headerText:'确认提交订单?',
                isShowBg:true,
                contentText:'#sell-layer-content',
                btn:[
                {
                    text:'取消',
                    method:'关闭',
