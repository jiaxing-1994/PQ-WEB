            ...
            <div v-show="tabType==1" class="stop-layer-a">
                <div class="content-item">
                    ...
                    <span class="item-title no-left-border">
                        {{selectContractItem.Direction==0||selectContractItem.HoldDirection==0?'多头':'空头'}}
                    </span>
                ...
                <div class="content-item">
                    ...
                    <span class="item-span layer-left">
                        ...
                        <span class="item-box">
                            {{selectContractItem.Direction==0||selectContractItem.HoldDirection==0?((price-selectLastData[3])/selectLastData[3]*100).toFixed(2):((selectLastData[3]-price)/selectLastData[3]*100).toFixed(2)}}%
                        </span>
                    </span>
                </div>
                <div class="content-item">
            ...
            <div v-show="tabType==2" class="stop-layer-b">
                ...
                <div class="content-item">
                    ...
                    <span class="item-span layer-left">
                        ...
                        <span class="item-box">
                            {{selectContractItem.Direction==1||selectContractItem.HoldDirection==1?((price-selectLastData[3])/selectLastData[3]*100).toFixed(2):((selectLastData[3]-price)/selectLastData[3]*100).toFixed(2)}}%
                        </span>
                    </span>
                </div>
                <div class="content-item">
