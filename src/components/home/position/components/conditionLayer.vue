        ...
        <div class="condition-layer-content">
            <div class="content-item">
                ...
                <span class="item-span layer-center">
                    {{selectContractItem.CommodityName}}
                </span>
...
export default {
    ...
    methods:{
        initData(){
            ...
            if(this.selectContractItem.ConditionType==0){
                //价格条件
                this.typeIndex = 0;
                //默认价格条件
                this.defaultConditionOption=this.conditionOptions[this.selectContractItem.CompareType];
                //默认价格类型
                this.defaultPriceTypeOption=this.priceTypeOptions[this.selectContractItem.OrderType];
                this.triggerPrice = this.selectContractItem.PriceTriggerPonit;
                this.preTriggerPrice = this.selectContractItem.PriceTriggerPonit;
                ...
                //时间条件
                this.typeIndex = 1;
                this.defaultConditionOption=this.conditionOptions[0];
                //默认价格类型
                this.defaultPriceTypeOption=this.priceTypeOptions[0];
                this.triggerPrice = this.selectLastData[3];
                this.preTriggerPrice = this.selectLastData[3];
                this.showTime = getFormalDate(new Date(this.selectContractItem.TimeTriggerPoint).getTime(),'hh:mm:ss');
                this.preShowTime = this.showTime;
                this.triggerTime = getFormalDate(new Date(this.selectContractItem.TimeTriggerPoint).getTime(),'yyyy/mm/dd hh:mm:ss'); 
            }
            //默认附加价格条件
            if(this.selectContractItem.AdditionFlag){
                //有附加条件
                this.defaultAdditionOption=this.additionOptions[this.selectContractItem.CompareType+1];
                this.additionPrice = this.selectContractItem.AdditionPrice;
                this.preAdditionPrice = this.selectContractItem.AdditionPrice;
            }else{
                //无
            ...
            //默认买卖方向
            this.defaultDirectionOption=this.directionOptions[this.selectContractItem.Direction];
            this.handNum = this.selectContractItem.Num;
        },
        switchTab(index){
        ...
        additionChange(item){
            ...
            if(item.name == '附加'){
                ...
                this.additionPrice = this.selectContractItem.PriceTriggerPonit;
            }
        },
        //买卖方向改变
